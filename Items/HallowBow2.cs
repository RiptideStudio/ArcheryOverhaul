...
{
	public class HallowBow2 : ModItem
	{
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient((Mod)null, "CobaltBow", 1);
			recipe.AddIngredient((Mod)null, "MythrilBow", 1);
			recipe.AddIngredient((Mod)null, "AdamantiteBow", 1);
			recipe.AddIngredient(1225, 10);
			recipe.AddIngredient(548, 5);
			recipe.AddIngredient(549, 5);
			recipe.AddIngredient(547, 5);
			recipe.AddTile(134);
			recipe.SetResult(mod.ItemType("HallowBow"), 1);
			recipe.AddRecipe();
		}
