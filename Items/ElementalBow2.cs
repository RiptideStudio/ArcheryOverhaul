...
{
	public class ElementalBow2 : ModItem
	{
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockback)
		{
			...
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, mod.ProjectileType("ElementalProj2"), damage, knockback, ((Entity)player).whoAmI, 0f, 0f);
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient((Mod)null, "IchorBow", 1);
