...
{
	public class GrenadeProj2 : ModProjectile
	{
		...
		public override void AI()
		{
			...
			int dust5 = Dust.NewDust(pos, projectile.width, projectile.height, 6);
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int i = 0; i < 6; i++)
			{
				...
				num = vector.X;
				num2 = vector.Y;
				Projectile.NewProjectile(center.X, center.Y, num, num2, 2, 18, num3, ((Entity)recipe).whoAmI, 0f, 0f);
			}
			for (int j = 0; j < 15; j++)
			{
