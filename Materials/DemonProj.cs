...
namespace bowmod.Materials
{
	public class DemonProj : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			for (int i = 0; i < 6; i++)
			{
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 65, 0f, 0f, 0, default(Color), 1f);
		...
		public override void AI()
		{
			...
			int dust = Dust.NewDust(projectilePosition, 0, 0, 65, 0f, 0f, 0, default(Color), 1f);
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			target.AddBuff(mod.BuffType("PainBuff"), 180, false);
		}
