...
namespace bowmod.Materials
{
	public class SandstormProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Dust.NewDust(projectile.position, projectile.width, projectile.height - 24, 32, 0f, 0f, 0, default(Color), 1f);
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 32, 0f, 0f, 0, default(Color), 1f);
				Dust.NewDust(projectile.position, projectile.width, projectile.height + 24, 32, 0f, 0f, 0, default(Color), 1f);
				Dust.NewDust(projectile.position, projectile.width, projectile.height - 48, 32, 0f, 0f, 0, default(Color), 1f);
				Dust.NewDust(projectile.position, projectile.width, projectile.height + 48, 32, 0f, 0f, 0, default(Color), 1f);
			}
		}
