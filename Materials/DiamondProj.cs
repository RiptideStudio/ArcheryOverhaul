...
namespace bowmod.Materials
{
	public class DiamondProj : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			for (int i = 0; i < 6; i++)
			{
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 63, 0f, 0f, 0, default(Color), 1f);
		...
		public override void AI()
		{
			...
			int dust = Dust.NewDust(projectilePosition, 0, 0, 63, 0f, 0f, 0, default(Color), 1f);
