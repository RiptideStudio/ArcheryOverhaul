	...
	public class SolarProj : ModProjectile
	{
		...
		public override bool OnTileCollide(Vector2 oldVelocity)
		{
			...
			for (int i = 0; i < 6; i++)
			{
				...
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 55, 0f, 0f, 0, default(Color), 1f);
			...
			Projectile.NewProjectile(center.X, center.Y, 0f, 0f, 612, 75, 4f, projectile.owner, 0f, 0f);
			return true;
		}
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			...
			Vector2 center = projectile.Center;
			Main.PlaySound(SoundID.Item14, (int)center.X, (int)center.Y);
			Projectile.NewProjectile(center.X, center.Y, 0f, 0f, 612, damage, 4f, projectile.owner, 0f, 0f);
			for (int i = 0; i < 6; i++)
			{
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 6, 0f, 0f, 0, default(Color), 1f);
				Dust.NewDust(projectile.position, projectile.width, projectile.height, 55, 0f, 0f, 0, default(Color), 1f);
