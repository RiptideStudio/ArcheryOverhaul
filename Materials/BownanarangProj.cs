...
{
	public class BownanarangProj : ModProjectile
	{
		...
		public override void AI()
		{
			...
			{
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, num + num2, -8f, ProjectileID.WoodenArrowFriendly, projectile.damage, 3f, ((Entity)recipe).whoAmI, 0f, 0f);
				Projectile.NewProjectile(projectile.position.X, projectile.position.Y, num + num2, 8f, ProjectileID.WoodenArrowFriendly, projectile.damage, 3f, ((Entity)recipe).whoAmI, 0f, 0f);
			}
		}
