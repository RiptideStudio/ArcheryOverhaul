...
{
	public class SteelArrowProj : ModProjectile
	{
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
		{
			for (int i = 0; i < 9; i++)
			{
				Dust.NewDust(projectile.position, projectile.width - 32, projectile.height - 32, mod.DustType("SteelDust"), 0f, 0f, 0, default(Color), 1f);
			}
		}
